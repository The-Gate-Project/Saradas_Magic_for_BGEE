...
IF ~!global("TalkedToSaradas","GLOBAL",1)~ THEN BEGIN 0 // from:
  ...
  IF ~~ THEN REPLY @101 /* ~Vediamo un po' cosa hai da offrire, mago.~ */ DO ~StartStore("!saradas",LastTalkedToBy(Myself)) setglobal("TalkedToSaradas","GLOBAL",1)~ EXIT
  IF ~~ THEN REPLY @102 /* ~A dire il vero andiamo un po' di fretta, sarà  per la prossima volta.~ */ DO ~setglobal("TalkedToSaradas","GLOBAL",1)~ EXIT
...
IF ~global("TalkedToSaradas","GLOBAL",1) GlobalLT("Chapter","GLOBAL",5) ~ THEN BEGIN 1 // from:
  ...
  IF ~~ THEN REPLY @109 /* ~Bentrovato, Saradas. Mostraci cio' che hai da vendere.~ */ DO ~StartStore("!saradas",LastTalkedToBy(Myself))~ EXIT
...
IF ~~ THEN BEGIN 2 // from: 0.2
  ...
  IF ~~ THEN REPLY @105 /* ~D'accordo nonnetto, fatti sotto! Ti faro' passare la voglia di parlare tanto.~ */ DO ~setglobal("TalkedToSaradas","GLOBAL",1) Enemy()~ EXIT
  IF ~~ THEN REPLY @106 /* ~Mmm...forse sara'  per la prossima volta! Ora sono...davvero moooolto impegnato...Non che non fossi in grado di batterti, si capisce...~ */ DO ~setglobal("TalkedToSaradas","GLOBAL",1)~ GOTO 3
END
...
IF ~GlobalGT("Chapter","GLOBAL",4) global("TalkedToSaradas","GLOBAL",1) global("SaradasTalkAfterDavaeorn","GLOBAL",0)~ THEN BEGIN 4
  ...
  IF ~~ THEN REPLY @117  /* ~Non sono affari tuoi, vecchio. Lasciami in pace una volta per tutte.~ */ DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1)~ GOTO 6
END
...
IF ~~ THEN REPLY @119 /* ~Grazie Saradas, ma c'e' ancora molto da fare...Arrivederci.~*/ DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN GiveConjurerSpell
  SAY @122
IF ~~ THEN REPLY @123 DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1) SetGlobal("SaradasGaveSpellClassCON","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN GiveWildSpell
  SAY @124
IF ~~ THEN REPLY @123 DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1) SetGlobal("SaradasGaveSpellClassWIL","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN GiveAbjurerSpell
  SAY @125
IF ~~ THEN REPLY @123 DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1) SetGlobal("SaradasGaveSpellClassABJ","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN GiveDivinerSpell
  SAY @126
IF ~~ THEN REPLY @123 DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1) SetGlobal("SaradasGaveSpellClassDIV","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN GiveEnchanterSpell
  SAY @127
IF ~~ THEN REPLY @123 DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1) SetGlobal("SaradasGaveSpellClassENC","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN GiveIllusionistSpell
  SAY @128
IF ~~ THEN REPLY @123 DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1) SetGlobal("SaradasGaveSpellClassILL","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN GiveInvokerSpell
  SAY @129
IF ~~ THEN REPLY @123 DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1) SetGlobal("SaradasGaveSpellClassINV","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN GiveNecromancerSpell
  SAY @130
IF ~~ THEN REPLY @123 DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1) SetGlobal("SaradasGaveSpellClassNEC","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN GiveTransmuterSpell
  SAY @131
IF ~~ THEN REPLY @123 DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1) SetGlobal("SaradasGaveSpellClassALT","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN GiveGeneralistSpell
  SAY @132
IF ~~ THEN REPLY @123 DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1) SetGlobal("SaradasGaveSpellClassGEN","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN GiveDragonSpell
  SAY @133
IF ~~ THEN REPLY @123 DO ~setglobal("SaradasTalkAfterDavaeorn","GLOBAL",1) SetGlobal("SaradasGaveSpellClassDRA","GLOBAL",1)~ EXIT
END
...
IF ~global("TalkedToSaradas","GLOBAL",1) global("SaradasTalkAfterDavaeorn","GLOBAL",1) GlobalGT("Chapter","GLOBAL",4) ~ THEN BEGIN 7 // from:
  SAY @108 /* ~Oh, siete tornati. Siete alla ricerca di qualche pergamena o artefatto? O forse di un amico...Non se ne ha mai abbastanza di questi tempi.~ */
  IF ~~ THEN REPLY @109 /* ~Bentrovato, Saradas. Mostraci cio' che hai da vendere.~ */ DO ~StartStore("!saradas",LastTalkedToBy(Myself))~ EXIT
  IF ~~ THEN REPLY @110 /* ~A dire il vero siamo solo di passaggio, e' tempo di rimettersi in viaggio.~ */ EXIT
  IF ~~ THEN REPLY @111 /* ~Ne' dell'uno ne' dell'altro. Trovati qualcun altro da importunare, vecchiaccio appiccicoso. Umph!~ */ EXIT
